...
#Model name
model = 'instaBCN_Inception_frozen_word2vec_tfidf_iter_60000'

#Output file
output_file_dir = '../../../hd/datasets/instaBarcelona/regression_output/' + model
...
while i < len(test):
    ...
    for x in range(0, batch_size):
        ...
        filename = '../../../hd/datasets/instaBarcelona/img_resized/' + test[i].split(',')[0] + '.jpg'
