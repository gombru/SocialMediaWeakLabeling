def create_solver(train_net_path, test_net_path=None, training_id='training', base_lr=0.001):
    ...
    s.snapshot = 20000
    s.snapshot_prefix = '../../../hd/datasets/instaBarcelona/models/CNNContrastive/'+ training_id
